...
class User:
    def __init__(self, id: str, first_name: str, last_name: str, email: str, password: str, role: str, disabled: bool = False):
        self.data = {}
        self.id = id
...
class UsersDB:
    ...
    def get_recors(self):
        headers = ['id', 'first_name', 'last_name', 'email', 'password', 'role', 'disabled']
    ...
    def login(self, email, password):
        ...
        if user is not None:
            ...
            if check_password:
                data = {'id': user['id'], 'first_name': user['first_name'], 'last_name': user['last_name'], 'email': user['email'], 'role': user['role']}
                return data
            else:
                return False
        return None